    ...
    <div className="min-h-screen bg-[#F7F5EE] flex flex-col items-center justify-center p-4 relative text-[#062C19]">
      ...
      >
        <div className="text-center space-y-2">
          ...
          <h2 className="text-2xl font-black text-[#062C19] tracking-tight">Create Reader Account</h2>
          <p className="text-xs font-medium text-[#062C19]/60">Join Book Manager to track your collection</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-xs font-bold text-[#062C19] mb-1">Full Name</label>
            <div className="relative">
              ...
              />
              <User className="w-4 h-4 text-[#062C19]/40 absolute left-3.5 top-3" />
            </div>
          </div>
        ...
        <p className="text-center text-xs font-semibold text-[#062C19]/70">
          ...
          <Link href="/login" className="text-[#062C19] font-black hover:underline">
            Sign In
          </Link>
        </p>
      </motion.div>
